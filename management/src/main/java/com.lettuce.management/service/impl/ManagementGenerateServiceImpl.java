...
import com.lettuce.management.utils.TemplateUtil;
 ...
 */
@Service
public class ManagementGenerateServiceImpl implements ManagementGenerateService {
    @Autowired
    ...
    public List<BeanField> listBeanField(String tableName) {
        ...
        beanFields.parallelStream().forEach(b -> {
            b.setName(StrUtils.str2hump(b.getColumnName()));
    ...
    public String upperFirstChar(String string) {
        String name = StrUtils.str2hump(string);
